...
export const SideBar = ({isAdmin = false}: SideBarProps) => {
  ...
  return (
    <nav className='z-sidebar sticky top-30 flex max-h-[calc(100vh-7.5rem)] flex-col gap-7.5 overflow-y-auto px-6.25'>
              ...
              return (
                <li key={href}>
                  <Link
                    ...
                    className={clsx(
                      'text-h5 flex w-full items-center gap-2 rounded-[10px] px-2 py-2.5 transition-colors',
                      isActive
