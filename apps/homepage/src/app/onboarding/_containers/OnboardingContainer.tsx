...
export const OnboardingContainer = () => {
  ...
  return (
    <div className='custom-scrollbar flex h-fit max-h-[90vh] w-full flex-col gap-11.75 overflow-y-auto rounded-[40px] border border-neutral-100/10 bg-neutral-100/20 px-5 py-9 shadow-xl lg:min-w-134.75 lg:px-11 lg:py-18.5'>
