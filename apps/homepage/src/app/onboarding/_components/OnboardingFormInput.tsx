...
export const OnboardingFormInput = ({
  ...
  return (
    <div className={clsx('flex flex-col gap-1.25 lg:gap-3', className)}>
      <label className='lg:text-h5 text-body-l text-neutral-100'>{label}</label>
      <input
        ...
        className={clsx(
          'w-full rounded-[9px] bg-neutral-800 px-4 py-3 text-neutral-100 transition-shadow outline-none lg:px-6.25 lg:py-4.75',
