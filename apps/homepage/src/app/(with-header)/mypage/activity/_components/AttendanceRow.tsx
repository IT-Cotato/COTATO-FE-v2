    ...
    {data.map((item) => {
      ...
      return (
        <tr key={item.sessionId} className='text-center'>
          ...
          <td className='h-8 max-w-15 truncate px-1 lg:h-12.25 lg:max-w-none'>
            {item.placeName || '-'}
          </td>
          <td>
          ...
          <td className='my-0.5 flex h-7 items-center justify-center lg:h-12.25 lg:py-[8.5px]'>
            <span
              className={clsx(
                'lg:text-body-m-sb text-body-m shadow-mobile lg:shadow-default flex h-full w-14.5 items-center justify-center rounded-[10px] text-white lg:w-18.75',
