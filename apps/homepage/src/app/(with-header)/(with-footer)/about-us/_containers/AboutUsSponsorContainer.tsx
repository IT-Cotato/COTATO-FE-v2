...
export const AboutUsSponsorContainer = () => {
  return (
    <motion.div
      className='flex w-full flex-col items-center gap-25 py-35 lg:py-50'
      ...
      <motion.div
        className='z-20 grid grid-cols-2 gap-x-2 gap-y-2 lg:flex lg:flex-row lg:items-center lg:gap-11'
        variants={FADE_IN_UP_CONTAINER}>
        {SPONSORS.map(
          ({id, src, link, alt, width, height, mobileWidth, mobileHeight}) => (
            <motion.div key={id} variants={FADE_IN_UP_ITEM}>
              <Link
                href={link}
                target='_blank'
