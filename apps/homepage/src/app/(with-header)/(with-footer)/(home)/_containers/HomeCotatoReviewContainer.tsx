...
const COTATO_REVIEWS_DATA = [
  ...
  },
  {
    ...
    longDescription:
      'API 작성도 어려워하고 프로젝트 경험도 부족했던 제가 스터디와 API 작성도 어려워하고 프로젝트 경험도 부족했던 제가 스터디와 프로젝트를 통해 코드 실력은 물론 파트간 협업을 경험하며 성장할 수 있었습니다. 그리고 서로 다른 학교, 학과에서 모인 사람들과 이야기하며 개발자로서 새로운 시야를 얻을 수 있었어요!',
  },
  {
    id: 10,
    generation: '10 ~ 11',
