...
const partData = {
  ...
  design: {
    title: 'Team Design',
    desc: [
      '사용자 여정을 설계하고 와이어프레임, 프로토타입, 디자인 시스템을 구축하며,',
      '팀과 협업하여 서비스의 완성도를 높입니다.',
    ],
  },
  frontend: {
    title: 'Team Frontend',
  ...
  backend: {
    title: 'Team Backend',
    desc: [
      'Spring 기반 서버 개발을 중심으로, API 설계부터 데이터베이스 구조 설계, 인증 처리와 배포 환경 구성까지',
      '서비스가 안정적으로 동작하고 성장할 수 있는 기반을 만들어갑니다.',
    ],
  },
};
