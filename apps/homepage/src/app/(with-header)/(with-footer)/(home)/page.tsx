...
export default function HomePage() {
  return (
    <div className='flex w-full flex-col gap-42.5 lg:gap-50'>
      <HomeBannerContainer />
      <div className='flex flex-col items-center gap-42.5 overflow-x-hidden bg-white px-6 pb-50 lg:gap-50'>
        <HomeCoreValue />
