...
export const BlackRowKeycap = ({
  ...
  return (
    <div
      ...
      />
      <span className='text-h4 xl:text-h2 absolute top-9.5 left-15.25 z-10 text-white transition-colors xl:top-16.5 xl:left-16.5'>
        {title}
      </span>
      <span className='text-h5 xl:text-h4 absolute bottom-5 left-15.25 z-10 text-neutral-100 opacity-0 transition-opacity group-hover:opacity-100 group-focus:opacity-100 group-focus-visible:opacity-100 xl:top-30.5 xl:left-16.5'>
        {subTitle}
      </span>
