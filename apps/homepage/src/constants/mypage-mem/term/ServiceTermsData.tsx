...
export const SERVICE_TERMS: TermsSection[] = [
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div className='flex items-start'>
          <span>1.</span>
          <span className='text-body-l-sb px-1'>“회원”</span>
          <span>
            이라 함은 본 약관에 동의하고 서비스 이용에 필요한 정보를 제공하여
            가입을 완료한 자를 말합니다.
          </span>
        </div>
        <div className='flex items-start'>
          <span>2.</span>
          <span className='text-body-l-sb px-1'>“아이디(ID)”</span>
          <span>
            이라 함은 회원의 식별과 서비스 이용을 위하여 회원이 설정하고
            동아리가 승인한 이메일 주소를 말합니다.
          </span>
        </div>
        <div className='flex items-start'>
          <span>3.</span>
          <span className='text-body-l-sb px-1'>“비밀번호”</span>
          <span>
            이라 함은 회원의 아이디와 일치되는지를 확인하고 회원의 개인정보를
            보호하기 위하여 회원이 정한 문자열을 말합니다.
          </span>
        </div>
        <div className='flex items-start'>
          <span>4.</span>
          <span className='text-body-l-sb px-1'>“Mait”</span>
          <span>
            이라 함은 코테이토와 연동되어 CS 퀴즈 서비스를 제공하는 외부
            플랫폼을 말합니다.
          </span>
        </div>
        <div>
          5. 이 약관에서 정의되지 않은 용어는 관련 법령 및 서비스 안내에서
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          ...
          신청한 후, 동아리가 이를 승인함으로써 효력이 발생합니다.
        </div>
        <div>
        ...
        <div>
          3. 동아리가 약관을 개정하는 경우, 개정 내용과 적용일자를 명시하여
          적용일 7일 전까지 이메일 등을 통해 공지합니다.
          <div className='pl-3.75'>
            다만 회원에게 불리한 변경 또는 중요한 사항의 변경인 경우에는 최소
            30일 전에 공지합니다.
          </div>
        </div>
        <div>
          4. 동아리가 변경 약관을 공지하면서 “변경 약관 시행일까지 거부 의사를
          표시하지 않으면 동의한 것으로 본다”는 내용을 명시하였음에도
          <div className='pl-3.75'>
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          ...
          정보를 기입하고, 본 약관 및 개인정보 처리방침에 동의함으로써
          회원가입을 신청합니다.
        </div>
        <div>
          2. 동아리는 내부 선발 기준 및 기수 운영 정책에 따라 가입 신청에 대한
          승인 여부를 결정하며, 그 결과(승인 또는 거절)를 가입 시 기재한
          이메일로 통지합니다.
        </div>
        <div>
          3. 동아리는 다음 각 호에 해당하는 경우 회원가입 신청을 승낙하지
  ...
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          1. 동아리가 회원에게 제공하는 서비스는 다음 각 호와 같습니다.
          <div className='pl-3.75'>a. 동아리 소개 및 리크루팅 정보 제공</div>
          <div className='pl-3.75'>
            b. 마이페이지를 통한 활동 내역 및 출석 관리
          </div>
          <div className='pl-3.75'>c. Mait 연동을 통한 퀴즈 서비스 제공</div>
          <div className='pl-3.75'>
            d. 서비스 최적화 및 사용자 경험 개선을 위한 이용 행태 분석 서비스
          </div>
        </div>
        <div>
          2. 회원은 별도의 가입 절차 없이 코테이토 계정 정보를 통해 Mait
          서비스를 이용할 수 있습니다. 이 경우 동아리는 개인정보 처리방침 및
          관련 법령에 따라 회원의 동의를 얻어,
          <div className='pl-3.75'>
        ...
        <div>
          ...
          구체적인 사항은 제10조 및
          <div className='pl-3.75'>개인정보 처리방침에 따릅니다.</div>
        </div>
        <div>
  ...
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        ...
        <div>
          3. 동아리는 제2항 각 호의 사유로 서비스가 중단되는 경우 가능한 한
          사전에 그 사실과 중단 기간을 공지합니다.
          <div className='pl-3.75'>
  ...
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          1. 회원은 서비스 이용과 관련하여 다음 각 호의 행위를 하여서는 안
          됩니다.
          <div className='pl-3.75'>
          ...
          <div className='pl-3.75'>
            e. 관련 법령, 본 약관, 서비스 내 공지사항 및 이용안내를 위반하는
            행위
          </div>
        </div>
        <div>
          2. 회원은 자신의 아이디 및 비밀번호 등 계정정보를 선량한 관리자의 주의
          의무로 관리하여야 하며, 이를 제3자에게 양도·대여·공개하여서는 안
          됩니다.
        </div>
        <div>
          3. 회원은 서비스 이용 중 개인정보(이메일, 연락처 등)에 변경이 있는
          경우 이를 지체 없이 수정하여야 하며, 이를 게을리하여 발생하는 불이익에
          대하여 동아리는 책임을 지지 않습니다.
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          1. 서비스 내 회원이 작성한 게시물 및 프로젝트 결과물(이하 “게시물
          등”)에 대한 저작권은 원칙적으로 해당 게시물 등을 작성한 회원에게
          귀속됩니다.
        </div>
        <div>
        ...
        <div>
          ...
          대한 책임은 회원 본인에게 있으며, 동아리는 고의 또는 중대한 과실이
          없는 한 이에 대하여 책임을
          <div className='pl-3.75'>부담하지 않습니다.</div>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        ...
        <div>
          3. 위 분석 도구는 쿠키(Cookie)를 통해 비식별 데이터를 수집할 수
          있으며, 회원은 브라우저 설정 등을 통해 쿠키 수집을 거부할 권리가
          있습니다.
        </div>
        <div>
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          ...
          정하는 바에 따라 지체 없이 이를
          <div className='pl-3.75'>처리합니다.</div>
        </div>
        <div>
        ...
        <div>
          3. 이용계약이 해지되는 경우, 동아리는 개인정보 처리방침 및 관련
          법령에서 정한 범위 내에서 회원의 개인정보를 보유·파기하며,
          <div className='pl-3.75'>
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          ...
          전기통신서비스 장애 등 불가항력적 사유로 인하여 서비스를 제공할 수
          없는 경우 그 책임을 지지 않습니다.
        </div>
        <div>
          2. 동아리는 회원의 귀책사유로 인한 서비스 이용 장애에 대하여 책임을
          지지 않습니다.
        </div>
        <div>
  ...
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>1. 이 약관의 해석 및 적용에는 대한민국 법령이 적용됩니다.</div>
        <div>
