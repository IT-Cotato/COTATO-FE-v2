...
export const PRIVACY_POLICY: TermsSection[] = [
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        ...
        이행합니다. <br />
        <div className='text-body-l-sb mt-2'>1. 회원 관리</div>
        <div className='pl-3.75'>
          • 회원가입 의사 확인, 본인 식별·인증, 비밀번호 재설정, 회원 자격
          유지·관리
        </div>
        <div className='text-body-l-sb'>2. 서비스 제공 및 운영</div>
        <div className='pl-3.75'>
          • 마이페이지 활동 기록 관리, 온·오프라인 세션 출석 확인, 서비스 품질
          개선 및 통계 분석, 사용자 행태 분석을 통한 UI/UX 최적화
        </div>
        <div className='text-body-l-sb'>3. 외부 서비스 연동</div>
        <div className='pl-3.75'>
  ...
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        ...
        <div className='text-body-l-sb mt-2'>
          1. 회원가입 시 수집하는 항목(필수)
        </div>
        <div className='pl-3.75'>
  ...
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        ...
        <div>2. 구체적인 보유 기간은 다음과 같습니다.</div>
        <div className='flex gap-1 pl-3.75'>
          <span className='text-body-l-sb shrink-0'>
            a. 회원가입 및 동아리 활동 관리:{' '}
          </span>
          <span>
        ...
        <div className='flex gap-1 pl-3.75'>
          ...
          <span>
            서비스 안정성 확보 및 이용 통계 분석을 위하여 수집일로부터 2년간
            보관 후 파기 (단, GA4 및 뷰저블의 데이터 보유 설정에 따름)
          </span>
        </div>
        <div className='flex gap-1 pl-3.75'>
          <span className='text-body-l-sb shrink-0'>
  ...
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        ...
        <div className='flex gap-1 pl-3.75'>
          <span className='text-body-l-sb shrink-0'>• 제공받는 자:</span>
          <span>Mait</span>
        </div>
        <div className='flex gap-1 pl-3.75'>
          <span className='text-body-l-sb shrink-0'>• 제공 목적:</span>
          <span>Mait 계정 자동 생성 및 로그인 연동, 퀴즈 서비스 제공</span>
        </div>
        <div className='flex gap-1 pl-3.75'>
          <span className='text-body-l-sb shrink-0'>• 제공 항목:</span>
          <span>이메일(아이디), 비밀번호(또는 로그인에 필요한 인증정보)</span>
        </div>
        <div className='flex gap-1 pl-3.75'>
          <span className='text-body-l-sb shrink-0'>• 보유·이용 기간:</span>
          <span>코테이토 회원 탈퇴 시 또는 Mait 서비스 종료 시까지</span>
        </div>
        <div>
  ...
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          1. 동아리는 원활한 서비스 제공 및 이용 행태 분석을 통한 사용자
          경험(UX) 개선을 위하여 다음과 같이 개인정보 처리 업무를 외부 업체에
          위탁하여 운영하고 있습니다.
        </div>
        <div>
        ...
        <div>
          3. Beusable(뷰저블)을 활용하여 이용자의 클릭, 마우스 움직임 등 서비스
          내 행동 패턴 분석 업무를 위탁 수행하며, 이를 통해 서비스의 UI/UX를
          최적화합니다.
        </div>
        <div>
          4. 동아리는 위탁계약 체결 시 「개인정보 보호법」 제26조에 따라
          위탁업무 수행목적 외 개인정보 처리금지, 기술적·관리적 보호조치,
          수탁자에 대한 관리·감독 등 관련 법령을 준수하며,
          <div className='pl-3.75'>
            수탁자가 개인정보를 안전하게 처리하도록 관리하고 있습니다.
          </div>
        </div>
        <div>
          5. 위 분석 도구들은 쿠키(Cookie)를 통해 비식별 정보를 수집하며,
          이용자는 제6조에 명시된 방법에 따라 데이터 수집을 거부할 수 있습니다.
        </div>
      </div>
    ),
  },
    ...
    content: (
      <div className='text-body-l pl-3'>
        ...
        <div>
          ...
          행사할 수 있습니다. 동아리는「개인정보 보호법」 및 관련 법령에 따라
          지체 없이 조치합니다.
        </div>
        <div>
          3. 정보주체는 법정대리인이나 위임을 받은 자 등 대리인을 통하여 권리를
          행사할 수 있으며, 이 경우 관련 법령에서 정한 위임장 서식을 제출하여야
          할 수 있습니다.
        </div>
        <div>
          4. 개인정보 열람 및 처리정지 요구는 「개인정보 보호법」 제35조 제4항,
          제37조 제2항에 따라 제한될 수 있으며, 다른 법령에서 해당 개인정보가
          수집 대상으로 명시된 경우 삭제를
          <div className='pl-3.75'>요구할 수 없습니다.</div>
        </div>
        <div>
        ...
        <div>
          ...
          외부 분석 도구의 데이터 수집을
          <div className='pl-3.75'>거부할 수 있습니다.</div>
        </div>
      </div>
    ),
  },
    ...
    content: (
      <div className='text-body-l pl-3'>
        ...
        <div className='flex gap-1'>
          <span className='text-body-l-sb shrink-0'>2. 파기 절차:</span>
          <span>
        ...
        <div className='pl-3.75'>• 종이 문서: 파쇄 또는 소각</div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          ...
          개인위치정보(실시간 GPS 위치)를 수집·이용할 수 있습니다.
        </div>
        <div>
        ...
        <div>
          3. 동아리는 개인위치정보를 제3자에게 제공하지 않으며, 향후 제공이
          필요한 경우 「위치정보의 보호 및 이용 등에 관한 법률」이 정한 동의
          절차를 거칩니다.
        </div>
        <div>
          4. 회원은 개인위치정보의 수집·이용 동의를 철회할 수 있으며, 동의 철회
          시 위치 기반 출석 서비스 이용이 제한될 수 있습니다.
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        ...
        <div className='flex gap-1'>
          <span className='text-body-l-sb shrink-0'>1. 관리적 조치:</span>
          <span>
            개인정보 취급자의 최소화, 정기적인 교육, 내부 관리계획 수립 및 시행
          </span>
        </div>
        <div className='flex gap-1'>
          <span className='text-body-l-sb shrink-0'>2. 기술적 조치:</span>
          <span>
            비밀번호 암호화, 접근권한 관리, 보안 프로그램 설치 및 주기적인 점검
          </span>
        </div>
        <div className='flex gap-1'>
          <span className='text-body-l-sb shrink-0'>3. 물리적 조치:</span>
          <span>개인정보가 저장된 시스템에 대한 물리적 접근 통제</span>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          1. 동아리는 개인정보 처리에 관한 업무를 총괄하여 책임지고, 개인정보
        ...
        <div className='flex gap-1 pl-3.75'>
          <span className='text-body-l-sb shrink-0'>• 소속/직책:</span>
          <span>코테이토 회장</span>
        </div>
        <div className='flex gap-1 pl-3.75'>
          <span className='text-body-l-sb shrink-0'>• 연락처:</span>
          <span>
  ...
  },
  {
    ...
    content: (
      <div className='text-body-l pl-3'>
        <div>
          1. 이 개인정보 처리방침은 법령, 지침 또는 동아리 정책 변경에 따라
          개정될 수 있습니다.
        </div>
        <div>
