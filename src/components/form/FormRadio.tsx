...
export const FormRadio = forwardRef<HTMLInputElement, FormRadioProps>(
  function FormRadio({label, className, ...props}, ref) {
    return (
      <label
        className={clsx('flex cursor-pointer items-center gap-6', className)}>
        ...
        <div className='relative flex items-center justify-center'>
          ...
          <div className='pointer-events-none absolute size-4.75 scale-0 rounded-full bg-primary transition-transform duration-200 peer-checked:scale-100' />
        </div>
