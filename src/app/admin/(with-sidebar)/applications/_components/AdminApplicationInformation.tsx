...
export const AdminApplicationInformation = () => {
  ...
  return (
    <div className='flex flex-row justify-between rounded-[10px] bg-neutral-100 pt-3 pr-7.25 pb-4.75 pl-3.5'>
      ...
      <div className='flex pt-1.25'>
        <div className='flex flex-row items-center gap-2.5 rounded-[10px] bg-white px-4 py-2.75'>
          <SearchIcon />
          <input
            type='text'
            ...
            className='text-body-l font-normal outline-none'
          />
        </div>
      </div>
    </div>
