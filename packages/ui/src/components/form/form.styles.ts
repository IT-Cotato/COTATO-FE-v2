export const formFieldStyles = {
  ...
  field:
    'placeholder-h5 lg:placeholder-body-l rounded-[10px] border-[1px] border-neutral-200 px-4 py-2.75 placeholder:text-neutral-400 focus:outline-none bg-white autofill:shadow-[inset_0_0_0_1000px_white]',
