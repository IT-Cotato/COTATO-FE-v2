...
export const CotatoLogo = () => {
  return (
    <div className='flex flex-col items-center gap-9.5'>
      <p className='text-h5 sm:text-h4 bg-linear-to-r from-[#F89202] via-[#F89202] to-[#9E9E9E] bg-clip-text font-bold whitespace-nowrap text-transparent'>
        COde Together, Arrive TOgether
      </p>
      <MainLogo
        role='img'
        aria-label='COTATO 로고'
        className='h-auto w-[189px] sm:w-auto'
      />
    </div>
  );
};
